...
/*
* Source from: https://github.com/google/accompanist/blob/main/placeholder/src/main/java/com/google/accompanist/placeholder/material3/Placeholder.kt
* */

package com.equationl.giteetodo.ui.widgets.placeholder
...
fun Modifier.placeholder(
    ...
    if (animationSpec != null && (visible || placeholderAlpha >= 0.01f)) {
        ...
        highlightProgress = infiniteTransition.animateFloat(
            initialValue = 0f,
            targetValue = 1f,
            animationSpec = animationSpec, label = "highlightProgress",
        ).value
    }
